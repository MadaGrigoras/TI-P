  ...
  <div class="align1 alignLeft12">
    ...
    <form method="post" action="SignUpServlet">
      <fieldset>
          ...
          <div>
            <input type="email" placeholder="Fill in with your Email adress" class="form-control" name="SEmail" id="SEmail" required>
          </div>
          
          <label class="align1" for="SPassword">Password</label>
          <div>
            <input type="password"  placeholder="Fill in with your new Password" class="form-control" name="SPassword" id="SPassword" required>
          </div>
          
          <label class="align1" for="SUsername">Username</label>
          <div>
            <input type="text" placeholder="Insert a new Username" class="form-control" name="SUsername" id="SUsername" required>
          </div>
			<br>
	...
	<div class="align1 alignRight12">
		...
		<form method="post" action="FirstServlet">
		  <fieldset>
			  <label class="align1" for="SEmail">Username</label>
			  <div>
				<input type="text" placeholder="Username" class="form-control" name="LUsername" id="LUsername" required>
			  </div>
			  
			  <label class="align1" for="SPassword">Password</label>
			  <div>
				<input type="password" placeholder="Password" class="form-control" name="LPassword" id="LPassword" required>
			  </div>

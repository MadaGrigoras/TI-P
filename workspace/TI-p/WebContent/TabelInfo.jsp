...
<!--<div class="alignCenter size500x370" id="tickets">
   ...
   one way ticket 
    <form method="post" action="FlightSearchServlet">
      <fieldset>
          ...
          <label class="align1" for="DepartureDate">Date</label>
          <div>
...
<%@ page import="servicii.web.*,servicii.web.Flight" %>
  <% 
...
String password = "";
	...
	String ar=request.getParameter("Destination");
	String dd=request.getParameter("DepartureDate");
	String sql="select * from flight where departure='"+dp+"' and arrival='"+ar+"' and departure_date= '"+dd+"' ";
	try{

  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
		<li><a href="#info">FLIGHTS' INFO</a></li>
...
<!-- Container (Flights Section) --> 
<div id="info" class="container-fluid text-center">
<h2>Flights' info</h2><br>

<script type = "application/javascript">
         function loadJSON(){
            var data_file = "http://localhost:8080/Ti-p_Pegasus/rest/FlightService/Flight";
            ...
            http_request.onreadystatechange = function(){
               ...
               if (http_request.readyState == 4  ){
				 ...
				 txt+= "<tr><th>Departure</th><th>Arrival</th><th>Date</th></tr>";
				 for(x in jsonObj)
				 {
                  txt+="<tr><td>"+jsonObj[x].arrival+"</td>";
                 	txt+="<td>"+jsonObj[x].departure+" </td>";
                  txt+="<td>"+jsonObj[x].date+"</td></tr>";
                  
				 }
				 txt+="</table>";
				   document.getElementById("paragraf").innerHTML = txt;
               }
            }
